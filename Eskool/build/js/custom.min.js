...
function init_sidebar() {
    function t() {
      ...
      //  $NAVCHILD.css("min-height", $(window).height());
    ...
    function o() {
        ...
        $SIDEBAR_MENU.find("li").removeClass("open open-sm"), $SIDEBAR_MENU.find("li").find("a").find("span.arrow").removeClass("fa-chevron-up"),
        $SIDEBAR_MENU.find("li").find("a").find("span.arrow").addClass("fa-chevron-down"), $SIDEBAR_MENU.find("li ul").slideUp()
    }
    $SIDEBAR_MENU.find("a").on("click", function (e) {
        ...
        var a = $(this).parent();
        if (a.is(".open")) {
            (a.removeClass("open open-sm"), a.find("a").find("span.arrow").toggleClass("fa-chevron-up fa-chevron-down"), $("ul:first", a).slideUp(function () {
                t()
            }))
        } else {
            (a.parent().is(".child_menu") ? $BODY.is("nav-sm") && (a.parent().is("child_menu") || o()) : o(), a.addClass("open"), a.find("a").find("span.arrow").toggleClass("fa-chevron-up fa-chevron-down"), $("ul:first", a).slideDown(function () {
                t()
            }))
        }
    }), $MENU_TOGGLE.on("click", function () {
        $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.open ul").hide(), $SIDEBAR_MENU.find("li.open").addClass("open-sm").removeClass("open")) : ($SIDEBAR_MENU.find("li.open-sm ul").show(), $SIDEBAR_MENU.find("li.open-sm").addClass("open").removeClass("open-sm")), $BODY.toggleClass("nav-md nav-sm"), t(), $(".dataTable").each(function () {
        ...
        t()
    }).parent().addClass("open"), $(window).smartresize(function () {
        t()
